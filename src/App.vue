<template>
  <div id="app">
    <vue-depth-chart :data="dynamicData" :customizeOptions="options" :theme="theme"></vue-depth-chart>
    <!-- <b-container  >
      <b-row>
        <b-col>
          <b-card no-body>
...
import VueDepthChart from './components/VueDepthChart.vue'
const buyArray = [
...
export default {
  ...
  data () {
    return {
      ...
      theme: 'day',
      staticData: { buy: buyArray, sell: sellArray }
    }
  },
  computed: {
    dynamicData () {
      return {
        buy: this.$store.state.book_depth.bids,
        sell: this.$store.state.book_depth.asks
      }
    }
    // getPage () {
    //   return this.perPage
